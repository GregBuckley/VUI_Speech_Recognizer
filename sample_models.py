...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    simple_rnn = GRU(units, activation='relu',
                     return_sequences=True, implementation=2, name='RNN_input')(input_data)
...
def final_model(filters, kernel_size, conv_stride, input_dim, conv_border_mode, units, recur_layers, output_dim=29):
    """ Build a deep recurrent network for speech 
    """
  # Main acoustic input
    dropout_rate=0.2
